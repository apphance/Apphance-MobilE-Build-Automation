...
class AndroidReleasePlugin implements Plugin<Project>{
    ...
    <div>
    <div>This is the plugin that provides simple release functionality.</div>
    <div><br></div>
    <div>It provides basic release tasks, so that you can upgrade version of the application
...
easily installable OTA version of your application.</div>
    <div><br></div>
    <div>Note that you need to load generic 'ameba-project-release' plugin before this plugin is loaded.</div>
    </div>
    """
