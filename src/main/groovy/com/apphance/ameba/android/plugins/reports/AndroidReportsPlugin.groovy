package com.apphance.ameba.android.plugins.reports
...
class AndroidReportsPlugin implements Plugin<Project>{

    static Logger logger = Logging.getLogger(AndroidReportsPlugin.class)
