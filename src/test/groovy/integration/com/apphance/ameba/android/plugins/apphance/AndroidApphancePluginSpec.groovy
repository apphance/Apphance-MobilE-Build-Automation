...
class AndroidApphancePluginSpec extends Specification {
    ...
    def "plugin tasks' graph configured correctly"() {
        ...
        project.tasks['convertLogsToApphance'].group == AMEBA_APPHANCE_SERVICE
        project.tasks['convertLogsToAndroid'].group == AMEBA_APPHANCE_SERVICE
        ...
        then: 'each task correct dependencies'
