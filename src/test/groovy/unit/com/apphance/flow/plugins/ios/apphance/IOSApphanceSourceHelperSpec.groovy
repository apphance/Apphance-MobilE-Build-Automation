...
import com.apphance.flow.plugins.ios.apphance.tasks.IOSApphanceSourceHelper
...
class IOSApphanceSourceHelperSpec extends Specification {
    ...
    def 'adds apphance when bracket is either in line or not in line'() {
        ...
        where:
        baseDir << [
                'src/test/resources/com/apphance/flow/plugins/ios/apphance/bracketInLine',
                'src/test/resources/com/apphance/flow/plugins/ios/apphance/bracketNotInLine'
        ]
    }
}
