...
class AndroidSingleVariantBuilderTest extends BaseAndroidTaskTest {
    ...
    public void testArtifactBuilderInfoVariantedDebug() throws Exception {
        ...
        assertEquals(new File("testProjects/android/srcTmp/bin").absolutePath, ai.buildDirectory.absolutePath)
        assertEquals(new File("testProjects/android/srcTmp/bin/TestAndroidProject-debug.apk").absolutePath, ai.originalFile.absolutePath)
    ...
    public void testArtifactBuilderInfoVariantedRelease() throws Exception {
        ...
        assertEquals(new File("testProjects/android/srcTmp/bin").absolutePath, ai.buildDirectory.absolutePath)
        assertEquals(new File("testProjects/android/srcTmp/bin/TestAndroidProject-release.apk").absolutePath, ai.originalFile.absolutePath)
    ...
    public void testArtifactBuilderInfoNotVariantedDebug() throws Exception {
        ...
        assertEquals('Debug', ai.debugRelease)
        assertEquals(new File("testProjects/android-novariants/srcTmp/bin").absolutePath, ai.buildDirectory.absolutePath)
        assertEquals(new File("testProjects/android-novariants/srcTmp/bin/TestAndroidProject-debug.apk").absolutePath, ai.originalFile.absolutePath)
    ...
    public void testArtifactBuilderInfoNotVariantedRelease() throws Exception {
        ...
        assertEquals('Release', ai.debugRelease)
        assertEquals(new File("testProjects/android-novariants/srcTmp/bin").absolutePath, ai.buildDirectory.absolutePath)
        assertEquals(new File("testProjects/android-novariants/srcTmp/bin/TestAndroidProject-release.apk").absolutePath, ai.originalFile.absolutePath)
