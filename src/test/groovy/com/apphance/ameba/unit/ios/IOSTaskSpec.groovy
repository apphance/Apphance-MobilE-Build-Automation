...
import static com.apphance.ameba.ios.plugins.buildplugin.IOSProjectProperty.DISTRIBUTION_DIR
import static com.apphance.ameba.ios.plugins.buildplugin.IOSProjectProperty.PLIST_FILE
import static com.apphance.ameba.ios.plugins.ocunit.IOSUnitTestPlugin.getAMEBA_IOS_UNIT
...
class IOSTaskSpec extends Specification {
    ...
    def 'plugins task are in correct group'() {
        ...
        ocUnitTasks    | [AMEBA_IOS_UNIT] * ocUnitTasks.size()
